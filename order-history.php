                            			...
                            			<tbody>
                            				...
                            				<tr>
                            					...
                            					<td class="cart-product-grand-total">
                            						<?php 
													$total = $row['paintingPrice'] * $row['quantity'] + $row['shippingCharge'];
													echo "$".$total; ?>
                            					</td>
                            					<td class="cart-product-sub-total">
                            						<?php echo $_SESSION['paymethod']; ?> 
                            					</td>
                            					<td class="cart-product-sub-total">
                            						<?php 
													$sqlQuery = "SELECT orderDate FROM orders WHERE paintingId = '".$row['pid']."'";
													$result = $pdo->query($sqlQuery);
													$row = $result->fetch();
													echo $row['orderDate']; 
													?>  
